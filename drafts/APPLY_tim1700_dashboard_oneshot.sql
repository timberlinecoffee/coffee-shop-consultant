-- TIM-1707 ONE-PASTE dashboard apply for the brand_config migration + bucket.
-- Paste this entire block into the Supabase SQL editor and Run. It is the
-- canonical migration plus a schema_migrations bookkeeping row so the repo file
-- supabase/migrations/20260602120000_tim1700_brand_config.sql stays drift-free.
...
-- ── migration bookkeeping (keeps check-migration-drift.mjs green) ─────────────
INSERT INTO supabase_migrations.schema_migrations (version, name)
VALUES ('20260602120000', 'tim1700_brand_config')
