  ...
  return (
    <div className="min-h-screen bg-neutral-100 flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="bg-white rounded-2xl border border-grey-light p-8 w-full max-w-sm shadow-sm">
        <h1 className="text-2xl font-bold text-neutral-950 mb-2 text-center">Create your account</h1>
        <p className="text-neutral-500 text-sm text-center mb-8">Start your coffee shop journey for free</p>
