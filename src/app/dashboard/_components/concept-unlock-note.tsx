...
export function ConceptUnlockNote({ show }: { show: boolean }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 mb-3 rounded-xl bg-[var(--teal)]/[0.06] px-4 py-2.5">
      ...
      <button
        ...
        onClick={dismiss}
        aria-label="Dismiss"
        className="text-[var(--teal)] hover:text-[var(--teal-dark)] flex-shrink-0 transition-colors"
      >
