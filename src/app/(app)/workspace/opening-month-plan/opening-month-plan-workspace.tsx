...
export function OpeningMonthPlanWorkspace({
  ...
  // TIM-3891: Analyse-with-AI state — one slot per section.
  ...
  // ── TIM-3891: Analyse-with-AI helpers ────────────────────────────────────────
  const runAnalyse = useCallback(
    async (
      ...
      if (isLoading) return; // double-fire guard — mirrors financials-v2 pattern
      setLoading(true);
      setError("");
      try {
