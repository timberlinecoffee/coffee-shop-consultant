// TIM-2253: Brand Settings workspace page. Follows the existing workspace
// convention — server component that fetches data, passes it to the client.
...
export default async function BrandSettingsPage() {
  ...
  if (config?.logo_path) {
    ...
    logoPublicUrl = urlData?.publicUrl ?? null;
  }
