...
export function OpeningMonthPlanWorkspace({
  ...
  const seedCtaLabel = playbookItems.length > 0 ? "Regenerate Opening Month Plan" : "Generate Opening Month Plan";
  const seedCtaDisabled = generating || !canEdit;
    ...
    <div className="bg-[var(--background)] min-h-screen">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-8 pb-16">
        ...
        <WorkspaceHeader
          ...
          actions={
            canEdit ? (
              <AskScoutButton workspaceKey="opening_month_plan" hasContent={hasContent} />
            ) : undefined
          }
        />
        ...
        <div className="space-y-4">
          ...
          {showMilestones && showStaleBanner && (
            <div className="rounded-xl bg-amber-50 border border-amber-200 px-4 py-3 flex items-start gap-3">
              ...
              <button onClick={() => setStalesBannerDismissed(true)} className="text-amber-500 hover:text-amber-700 flex-shrink-0">
                <X size={14} />
              </button>
            </div>
          )}
          ...
          {section === "playbook" ? (
            ...
            <div className="bg-white rounded-xl border border-[var(--border)] px-4 sm:px-5 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              <div className="flex flex-col gap-1.5 sm:items-end">
                ...
                >
                  ...
                  {generating ? "Generating..." : seedCtaLabel}
                </button>
                {!canEdit && (
            ...
            /* Milestones / unified: target date only — Scout generates via chat. */
