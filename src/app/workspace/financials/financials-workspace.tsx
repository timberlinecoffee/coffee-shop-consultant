...
function ProjectionsTab({
  ...
  function generateAssessment() {
    ...
    requireAiConsent(() => void runAssessment());
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-[var(--border)] bg-white overflow-hidden">
        ...
        {localAssessment && (
          <p className="px-5 pb-4 text-[10px] leading-relaxed text-[var(--muted-foreground)] border-t border-[var(--neutral-cool-100)] pt-3">
            <span className="font-semibold">AI Assessment, Not Financial Advice.</span>{" "}
            This assessment is generated by AI from the projections you entered. It is not
            financial planning, accounting services, investment advice, or a professional business
            audit. Industry benchmarks are generalized. Before acting on this assessment, consult a
            licensed accountant (CPA/CA) or qualified business advisor.{" "}
            <span className="text-[var(--teal)]">
              Colorado users: if you believe this assessment has materially affected a consequential
              decision, you may{" "}
              <a
