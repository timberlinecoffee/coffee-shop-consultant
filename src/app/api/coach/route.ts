...
export async function POST(request: NextRequest) {
  ...
  if (!isUnlimited && profile.ai_credits_remaining < 1) {
    return Response.json({ error: "You have used all your AI credits for this month. Upgrade to Pro for unlimited coaching, or wait for your monthly reset." }, { status: 402 });
  }
