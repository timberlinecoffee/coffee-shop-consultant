...
// TIM-2980: Resolve via `getActivePlanId` so the seed lands in the active plan
// (the one the rest of the suite reads/writes), not the latest-by-created one
// (mirrors TIM-2965 / TIM-2377).
