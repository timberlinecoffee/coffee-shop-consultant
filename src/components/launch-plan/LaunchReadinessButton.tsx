  ...
  return (
    <div className="bg-white rounded-xl border border-[var(--border)] p-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          type="button"
          onClick={() => requireAiConsent(() => void runCheck())}
...
function ReadinessResultView({ result }: { result: ReadinessResult }) {
  ...
  return (
    <div className="mt-5 space-y-5">
      ...
      {/* TIM-1359: Surface 4 disclaimer + CO right-to-contest */}
      <p className="text-[10px] leading-relaxed text-[var(--muted-foreground)] border-t border-[var(--border)] pt-3">
        <span className="font-semibold">AI Readiness Assessment, Not a Professional Audit.</span>{" "}
        This readiness status is generated by AI from your plan inputs. A &quot;green&quot; status
        means your plan appears internally consistent, not that your business is ready to open or
        that you are legally compliant. Verify permits, licenses, health codes, and financing
