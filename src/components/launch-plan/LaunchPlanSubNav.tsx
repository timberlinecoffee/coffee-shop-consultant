...
// inside one suite — matching the EquipmentSuppliesSubNav pattern used by the
// Equipment & Supplies suite. Replaces the old two-card landing page, which
// was the only suite in Groundwork to navigate via clickable cards (board
// flagged the inconsistency on TIM-1407).
