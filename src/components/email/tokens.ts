// TIM-2362: shared design tokens for all Groundwork email templates (Resend + Klaviyo).
// Matches the live Groundwork UI token set from TIM-1537.
// CTO: install @react-email/components before importing EmailLayout/Header/Footer/Button.
