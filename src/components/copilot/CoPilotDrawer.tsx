        ...
        >
          ...
          >
            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
              ...
              {/* TIM-1561: "Review changes →" / "Review N suggestions" CTA when Scout emits a suggestions event. */}
              {/* TIM-2381: suggest_workspace_changes proposals use "Review changes →" label. */}
