        ...
        >
          ...
          >
            ...
            <header className="px-4 pt-4 pb-3 border-b border-[var(--border)] flex items-start gap-2">
              ...
              {!isMobile && (
                <button
                  ...
                  className="ml-1 w-8 h-8 rounded-full hover:bg-[var(--neutral-cool-100)] flex items-center justify-center text-[#888]"
              ...
              <button
                ...
                aria-label="Close"
                onClick={closeDrawer}
                className="w-8 h-8 rounded-full hover:bg-[var(--neutral-cool-100)] flex items-center justify-center text-[#888]"
              >
                <X className="w-4 h-4" />
              </button>
            </header>
            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
              ...
              {showEmpty && (
                <div className="text-sm text-[#666] bg-[var(--background)] border border-[var(--border)] rounded-xl p-4">
                  {activeScope === null
            ...
            >
              ...
              >
                <textarea
                  ...
                  className="flex-1 resize-none rounded-xl border border-[var(--gray-600)] bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[var(--teal)]/40 disabled:bg-[var(--surface-warm-50)] disabled:text-[#888]"
                />
                {isStreaming ? (
                  <button
                    type="button"
