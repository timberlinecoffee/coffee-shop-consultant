  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex items-start justify-between gap-3">
        ...
        <Button size="sm" onClick={() => requireAiConsent(() => void run())} disabled={loading} className="shrink-0">
      ...
      {text && (
        <div className="rounded-xl border border-[var(--border)] bg-[var(--surface-warm-50)]/40 px-4 py-4">
          ...
          {/* TIM-1359: Surface 7 point-of-output disclaimer */}
          <AiDisclaimer
            className="mt-3 border-t border-[var(--border)] pt-3"
            lead="AI Neighborhood Analysis."
            body="Generated by AI from publicly available map data (OpenStreetMap). Data may be outdated or incomplete. Conduct independent site visits and consult a commercial real estate broker before signing any lease."
          />
        </div>
      )}
    </div>
