  ...
  const field = (
    ...
    <div>
      ...
      <input
        ...
        className="w-full border border-[var(--gray-650)] rounded-lg px-3 py-2 text-sm text-[var(--foreground)] placeholder-[var(--dark-grey)] focus:outline-none focus:border-[var(--teal)] bg-white transition-colors"
      />
    </div>
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        type="button"
        onClick={addEntry}
        className="flex items-center gap-2 text-sm text-[var(--teal)] hover:underline focus:outline-none"
      >
      ...
      <div className="pt-2">
        <button
          type="button"
          onClick={onDefer}
          className="text-sm text-[var(--muted-foreground)] hover:text-[var(--teal)] hover:underline focus:outline-none transition-colors"
        >
