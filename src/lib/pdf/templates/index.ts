...
import { scorecardWorksheetTemplate } from "./interview-scorecard-worksheet"
...
registerTemplate("hiring_scorecard_worksheet", scorecardWorksheetTemplate as PdfTemplate) // TIM-1482
