...
export const SCOUT_LANES = [
  ...
  // TIM-3890: Suppliers workspace analyse lane.
  "analyse_suppliers_category",
...
export const FORCE_ANTHROPIC_LANES = new Set<ScoutLane>([
  ...
  "document_import_extract",
  "buildout_import",
  // TIM-3878/TIM-3885: Analyse lanes require structured JSON output — Anthropic for reliability.
  "analyse_location_property",
  "analyse_location_shortlist",
  "analyse_lease_terms",
  "analyse_marketing_channels",
  ...
  "analyse_financials_cogs_menu",
  "analyse_financials_cogs_additional",
  // TIM-3890: Suppliers category analyse lane — structured JSON, Anthropic for reliability.
  "analyse_suppliers_category",
])
