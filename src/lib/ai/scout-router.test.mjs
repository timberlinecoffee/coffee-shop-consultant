...
//    behavior." Lane count updated by TIM-3884 (42 lanes).
...
test("registry has 42 lanes (plan §3 taxonomy + TIM-3885/3887/3888/3901/3884 analyse lanes)", () => {
  assert.equal(SCOUT_LANES.length, 42)
})
